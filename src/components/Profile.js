...
import { Users, Percent, Target, List, Receipt } from 'lucide-react';
...
export default function Profile() {
  ...
  const summaryData = [
    { label: '누적 충전', value: '0원' },
    { label: '누적 환전', value: '0원' },
    { label: '누적 손·환', value: '0원' },
    { label: '보유 머니', value: '9원' },
    { label: '보유 엘리비', value: '0원' },
    { label: '지갑', value: '0' }
  ];
